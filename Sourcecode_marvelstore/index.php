...
<html lang="">
<?php 
if(isset($_GET['method']) && isset($_GET['id']) && $_GET['method']=='product-detail'){
	include_once 'server/header-tag.php';
}else{
...
<body>
	<!-- Nhúng FB SDK -->
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=3440048582721380&autoLogAppEvents=1" nonce="usB2CBM1"></script>
	<!-- END FB SDK -->
