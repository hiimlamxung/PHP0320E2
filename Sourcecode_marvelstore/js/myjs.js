...
function updatecart(id){
	...
	if(qty>quantity){
		...
		$.get('server/product/update-cart.php',{id:id,qty:qty}, function(data) {
			...
			$("#box_cart_res").load(" .icon-nav-res");// load lại cart phía top,của responsive
			$("#box_cart-icon").load(" .cart-icon");
		});
...
//Cập nhật sẵn ss cart cho tài khoản đã đăng nhập mỗi khi load lại trình duyệt
function set_SS_datacart(){
	$.post('server/info/set-ss-datacart.php', function(data) {
