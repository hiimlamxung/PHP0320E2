...
unset($_SESSION['news']);
?>
<div id="tbl_news_boxout" style="overflow: auto;">
<table class="table table-hover" id="tbl_news_boxin">
	<thead>
		<tr>
			<th>STT</th>
			<th>Ảnh Tin tức</th>
			...
			<tr>
				...
				<td><?php echo $value['title']; ?></td>
					...
					<td><div id="tbl_banner_boxin">
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal-<?php echo $value['id_news']; ?>" >
							Xem chi tiết bài viết và sửa nội dung
						</button>

						<div class="modal fade" id="exampleModal-<?php echo $value['id_news']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
							...
							<button type="button" class="btn btn-danger del_news" value="<?php echo $value['id_news']; ?>">Xóa</button>
						</td>
