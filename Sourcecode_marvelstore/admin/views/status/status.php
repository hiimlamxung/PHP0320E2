...
<div class="row">
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Lượt đánh giá SP</div>
                    </div>
                </div>
            </div>
            <a href="index.php?page=home&views=status&action=report-raiting">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="index.php?page=home&views=customer">
                <div class="panel-footer">
                    <span class="pull-left">Xem chi tiết</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Đơn hàng đang chờ được xử lý</div>
                    </div>
                </div>
            </div>
            <a href="index.php?page=home&views=order" id="odering">
                <div class="panel-footer">
                    <span class="pull-left">Xem chi tiết</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
