			...
			<div class="modal-body">
				<form action="" method="POST" role="form" onsubmit="return Validate_voucher();">
					...
					<div class="form-group">
						...
						<input type="text" name="code_voucher" class="form-control" id="address" onblur="blur_address();" value="<?php if(isset($code_voucher)){echo $code_voucher;} ?>">
					</div>
					<div class="form-group">
						<label for="">Áp dụng cho đơn hàng có trị giá từ</label><span id="span_orderprice" class="spanerror"></span>
						<input type="number" name="apply_for" onkeypress="return onlyNum();" class="form-control" id="orderprice" onblur="BlurOrderPrice();" value="<?php if(isset($apply_for)){echo $apply_for;} ?>">
					</div>
					<div class="form-group">
						<label for="">Số ngày code tồn tại (*/ngày)</label><span id="spand_timeapply" class="spanerror"></span>
						<input type="number" name="time_apply" onkeypress="return onlyNum();"  class="form-control" id="timeapply" onblur="Blurtimeapply();" value="<?php if(isset($time_apply)){echo $time_apply;} ?>">
					</div>
					<div class="form-group">
						<label for="">% giảm giá</label><span id="spandiscount" class="spanerror"></span>
						<input type="number" name="discount" onkeypress="return onlyNum();"  class="form-control" id="discount" onblur="Blurdiscount();" value="<?php if(isset($discount)){echo $discount;} ?>">
					</div>
...
<div id="tbl_voucher_boxout">
	<div id="tbl_voucher_boxin" style="overflow: auto;">
