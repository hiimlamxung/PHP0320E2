			...
			<div class="modal-body">
				<form action="" method="POST" role="form" onsubmit="return Validate_addUser();">
					...
					<div class="form-group">
						...
						<input type="text" name="name_user" class="form-control" id="name" onblur="blur_name();" value="<?php if(isset($name_user)){echo $name_user;} ?>">
					</div>
					<div class="form-group">
						<label for="">Số Điện Thoại</label><span id="spanphone" class="spanerror"></span>
						<input type="phone" name="phone" onkeypress="return onlyNum();" class="form-control" id="phone" onblur="blur_phone();" value="<?php if(isset($phone)){echo $phone;} ?>">
					</div>
					<div class="form-group">
						<label for="">Email</label><span id="spanemail" class="spanerror"></span>
						<input type="email" name="email"  class="form-control" id="email" onblur="blur_email()" value="<?php if(isset($email)){echo $email;} ?>">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="address"  class="form-control" id="address" onblur="blur_address();" value="<?php if(isset($address)){echo $address;} ?>">
					</div>
