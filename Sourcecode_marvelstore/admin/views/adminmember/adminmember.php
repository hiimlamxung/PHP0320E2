			...
			<div class="modal-body">
				<form action="" method="POST" role="form" onsubmit="return Validate_admin();">
					...
					<div class="form-group">
						...
						<input type="password" name="pass" class="form-control" id="pass" onblur="blur_pass();">
					</div>
					<div class="form-group">
						<label for="">Nhập lại mật khẩu</label><span id="spanrepass" class="spanerror"></span>
						<input type="password" name="repass" class="form-control" id="repass" onblur="blur_repass();">
					</div>
					<div class="form-group">
...
<div id="tbl_admin_boxout">
	<div id="tbl_admin_boxin" style="overflow: auto;">
		<?php 
