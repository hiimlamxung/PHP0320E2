<div class="container" >
	<div class="row" id="box_show_product" style="">
		<ol class="breadcrumb" >
			<li>Trang chủ</li>
			...
			<div class="col-md-4 col-md-push-1  col-xs-12 box_price" style="">
				...
				?>				
				<div class="fb-like" id="like_share_product" data-href="http://php0320e2-3.itpsoft.com.vn/product-detail/<?php echo $value['id_product']; ?>/<?php echo $value['url_name']; ?>" data-width="280px" data-layout="standard" data-action="like" data-size="small" data-share="true"></div>
	...
	<div class="row" id="visited_box">
		...
		foreach ($_SESSION['seen'] as $key => $value) {
			...
			<div class="col-md-1 col-xs-2" style=""><a href="product-detail/<?php echo $value['id_product'].'/'.$value['url_name']; ?>"><img class="list_img_visited" src="<?php echo $value['img']; ?>" alt=""></a></div>
