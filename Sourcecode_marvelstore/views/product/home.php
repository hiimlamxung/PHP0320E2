		...
		<div class="row">
			...
			foreach ($rs_hot as $key => $hot) {
				...
				<div class="col-md-3 col-xs-6 product_box">
					<a href="product-detail/<?php echo $hot['id_product'].'/'.$hot['url_name']; ?>">
					<div class="thumbnail">
						<div class="set">
							<div href="#" class="box_img_out"><img src="<?php echo $hot['img']; ?>" alt="..." class="img_product">
		...
		<div class="row">
			...
			<div class="row">
				...
				foreach ($rs_mv as $key => $mv) {
					...
					?>
					<div class="col-md-3 col-xs-6 product_box">
						<a href="product-detail/<?php echo $mv['id_product'].'/'.$mv['url_name']; ?>">
						<div class="thumbnail" style="">
							<div class="set">
								<div href="#" class="box_img_out" ><img src="<?php echo $mv['img']; ?>" class="img_product" alt="..." style="">
									<button class="btn btn-danger shower"  data-toggle="modal" value="<?php echo $mv['id_product']; ?>" data-target=".bs-example-modal-lg">Xem nhanh</button>
			...
			<div class="row">
				...
				<div class="row">
					<?php 
					 ...
					 ?>
					<div class="col-md-3 col-xs-6 product_box" >
						<a href="product-detail/<?php echo $dc['id_product'].'/'.$dc['url_name']; ?>">
						<div class="thumbnail" style="">
							<div class="set">
								<div href="#" style="" class="box_img_out"><img style="" src="<?php echo $dc['img']; ?>" class="img_product" alt="...">
