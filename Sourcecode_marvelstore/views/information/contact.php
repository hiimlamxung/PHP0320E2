			...
			<form action="" method="POST" role="form" onsubmit="return Validate_contact();">
				<div class="col-md-6">
					...
					<div class="row" style="min-height: 200px;">
						...
						<span id="check" style="color:red;text-align: center">
							<?php 
							if(isset($_SESSION['noti_contact']) && $_SESSION['noti_contact']==1){
								...
								echo "<script>setTimeout(function(){
									alert('Cảm ơn đóng góp ý kiến của bạn, MarvelStore sẽ phản hồi lại bạn nhanh nhất có thể');
								}, 1000);</script>";
								...
								echo "<script>setTimeout(function(){
									alert('Thất bại! Có lỗi trong quá trình gửi');
								}, 1000);</script>";
							}
