		...
		<div id="box_cart-icon"><button class="cart-icon" title="Xem chỉ tiết giỏ hàng"><a href="cart" style="position: relative;"><i class="fa fa-shopping-cart fa-2x" aria-hidden="true"></i><?php 
							if(isset($_SESSION['cart']) && !empty($_SESSION['cart'])){
								?>
								<span id="cart_nums_left"><?php echo $_SESSION['cart_qty']; ?></span>
								<?php
							}else{
								?>
								<span id="cart_nums_left">0</span>
								<?php
							}
							?></a></button></div>
		<!-- end -->
