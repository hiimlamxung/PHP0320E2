  ...
  <div class="row">
    <div class="col-md-12">
      ...
      if(empty($_SESSION['cart'])){
        ...
        ?>
        <div id="show_noti_cart"></div>
        <div id="table-cart">
          <table class="shop-table" id="shop_cart">
            <thead>
              <tr>
                <th>
                  Hình ảnh
              ...
              <tbody>
                ...
                foreach ($_SESSION['cart'] as $key => $value) {
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>" value="<?php echo $value['qty']; ?>" min="1" max="10" onchange="update_cart(<?php echo $value['id']; ?>);" >
                    </td>
                    <td>
                      <h5>
                        <strong class="red" id="<?php echo "total".$value['id']; ?>">
                          <?php 
                    ...
                    <td>
                      <a href="">
                        <button value="<?php echo $value['id']; ?>" class="btn btn-warning delete_cart" style="color: #000;">
                        Xóa Ajax
                      </button>
                      </a>
                    </td>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12" id="sum_price">
            <div class="shippingbox">
              <div class="grandtotal">
                <h5>
                  GRAND TOTAL 
                </h5>
                <span style="font-size:18px;" id="grandtotal">
